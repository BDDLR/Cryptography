 ...
 * @author Bryan
 */
public class desaes extends javax.swing.JFrame {
    ...
    public desaes() throws NoSuchAlgorithmException {
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new desaes().setVisible(true);
                } catch (NoSuchAlgorithmException ex) {
                    Logger.getLogger(desaes.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
